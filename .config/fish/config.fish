...
alias containedvscodehere 'newcontainerrw -v /tmp/.X11-unix/:/tmp/.X11-unix:ro -v /usr/:/usr/:ro -v /opt/:/opt/:ro -v $HOME/.fonts:$HOME/.fonts:ro -e DISPLAY=:0 --entrypoint code maowtm/bare --new-window --verbose .'
